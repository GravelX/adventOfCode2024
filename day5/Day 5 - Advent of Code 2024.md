...
<p>The North Pole printing department is busier than ever this close to 
Christmas, and while The Historians continue their search of this 
historically significant facility, an Elf operating a <a href="https://adventofcode.com/2017/day/1">very familiar printer</a> beckons you over.</p>
...
<p>Because the first update does not include some page numbers, the 
ordering rules involving those missing page numbers are ignored.</p>
<p>The second and third updates are also in the correct order according 
...
<p>For some reason, the Elves also need to know the <em>middle page number</em>
...
correctly-ordered updates are:</p>
...
<p>Your puzzle answer was <code>4689</code>.</p><article class="day-desc">
...
<p>For each of the <em>incorrectly-ordered updates</em>, use the page 
...
<p>Your puzzle answer was <code>6336</code>.</p>